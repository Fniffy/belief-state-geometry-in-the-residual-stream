...
"""
    took from Attention Is All You Need (Vaswani et al., 2017)
"""
...
class TransformerBlock(nn.Module):
    def __init__(self, embed_size, heads, dropout, forward_expansion):
        ...
        self.attention = SelfAttentio(embed_size, heads)
...
class Transformer(nn.Module):
    ...
    def make_trg_mask(self, trg):
        ...
        nopeak_mask = torch.tril(torch.ones((1, trg_len, trg_len))).bool()
        
        trg_mask = trg_mask & nopeak_mask.to(self.device)
